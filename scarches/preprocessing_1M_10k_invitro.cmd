...
#SBATCH -o /home/icb/jonas.flor/gast_atlas_clean/scarches/bash_messages/outputs_prep_1M_10k_in
#SBATCH -e /home/icb/jonas.flor/gast_atlas_clean/scarches/bash_messages/errors_prep_1M_10k_in
#SBATCH -J prep_1M_10k_in
#SBATCH -p cpu_p
#SBATCH --qos=cpu_long
...
mamba activate scvi
python /home/icb/jonas.flor/gast_atlas_clean/scarches/preprocessing.py invitro 1M 10k_genes


sbatch /home/icb/jonas.flor/gast_atlas_clean/cellrank/analysis_invitro_10k_integrated.cmd
