...
#SBATCH -o /home/icb/jonas.flor/gast_atlas_clean/scarches/bash_messages/outputs_spaces_1M_all_ex
#SBATCH -e /home/icb/jonas.flor/gast_atlas_clean/scarches/bash_messages/errors_spaces_1M_all_ex
...
path="$(grep -i 'error' /home/icb/jonas.flor/gast_atlas_clean/scarches/bash_messages/errors_spaces_1M_all_ex)"
if [ -z "$path" ]
then
