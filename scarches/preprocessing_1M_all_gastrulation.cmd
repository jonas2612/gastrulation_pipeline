...
#SBATCH -o /home/icb/jonas.flor/gast_atlas_clean/scarches/bash_messages/outputs_prep_1M_all_gast
#SBATCH -e /home/icb/jonas.flor/gast_atlas_clean/scarches/bash_messages/errors_prep_1M_all_gast
#SBATCH -J prep_1M_all_gast
#SBATCH -p cpu_p
#SBATCH --qos=cpu_long
...
mamba activate scvi
python /home/icb/jonas.flor/gast_atlas_clean/scarches/preprocessing.py gastrulation 1M all_genes


sbatch /home/icb/jonas.flor/gast_atlas_clean/cellrank/analysis_gastrulation_all_integrated.cmd
